...
export default function MacacoCarousel() {
  ...
  const getItemStyle = (index: number) => {
    ...
    const radius = 1000; // volta ao raio anterior
  ...
  return (
    <div className="carousel-container relative w-full max-w-[1600px] mx-auto h-[700px] px-4">
      {/* Botões para mobile - acima do carrossel */}
      ...
      <Button
        ...
        variant="outline"
        size="icon"
        className="absolute left-4 top-1/2 -translate-y-1/2 rounded-full z-50 bg-white/20 hover:bg-white/30 backdrop-blur-sm"
      >
      ...
      <div className="carousel relative w-full h-full">
        ...
        {/* Botões desktop dentro do carrossel */}
      ...
      <Button
        ...
        variant="outline"
        size="icon"
        className="absolute right-4 top-1/2 -translate-y-1/2 rounded-full z-50 bg-white/20 hover:bg-white/30 backdrop-blur-sm"
      >
